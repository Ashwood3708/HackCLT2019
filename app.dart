...
class SplashScreenState extends State<SplashScreen>
  ...
  AnimationController _fiveStepController;
  AnimationController _sixStepController;
  AnimationController _sevenStepController;
  AnimationController _finalStepController;
  ...
  List<SecondQuestion> usingCollection = [
    SecondQuestion('firstBracket', '\$0-\$16,000'),
    SecondQuestion('secondBracket', '\$16,001-\$30,000'),
    SecondQuestion('thirdBracket', '\$30,001-\$47,000'),
    SecondQuestion('fourthBracket', '\$47,001+'),
  ];

  List<FourthQuestion> yesno = [
    FourthQuestion('yes', 'yes'),
    FourthQuestion('no', 'no'),
  ];

  List<FiveQuestion> childNum = [
    FiveQuestion('none', '0'),
    FiveQuestion('one', '1'),
    FiveQuestion('two', '2'),
    FiveQuestion('three', '3'),
    FiveQuestion('four', '4+'),
  ];
  ...
  Animation<double> fiveTranformAnimation;
  Animation<double> sixTranformAnimation;
  Animation<double> sevenTranformAnimation;
  Animation<double> finalTranformAnimation;
  ...
  void initState() {
    ...
    _sevenStepController = AnimationController(
        duration: Duration(milliseconds: 1000), vsync: this);
    _finalStepController = AnimationController(
        duration: Duration(milliseconds: 1000), vsync: this);
                ...
                onTap: () {
                  setState(() {
                    ...
                    if (curIndex == 1) {
                      ...
                      _startFinalStepAnimation();
                    }
                  });
                },
                child: Center(
                    child: Text(
                  curIndex < 7 ? 'Continue' : 'Finish',
                ...
                Expanded(
                  child: Center(
                    child: Container(
                      ...
                      child: Card(
                        child: Column(
                          children: List.generate(yesno.length, (int index) {
                            final using = yesno[index];
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('What is your yearly income?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 258.0,
  ...
  List<ThirdQuestion> thirdQuestionList = [
    ThirdQuestion('Male', false),
    ThirdQuestion('Female', false),
    ThirdQuestion('Other', false),
  ];
                ...
                Expanded(
                  child: Center(
                    child: Container(
                      ...
                      child: Card(
                        child: Column(
                          children: List.generate(childNum.length, (int index) {
                            final using = childNum[index];
                            return GestureDetector(
                              onTapUp: (detail) {
                                setState(() {
                                  usingTimes = using.identifier;
          ...
          child: Opacity(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                    margin: EdgeInsets.only(top: 16.0),
                    child: Text('Do you do any strenuous activity?')),
                Expanded(
                  child: Center(
                    child: Container(
                      height: 258.0,
...
Widget _getLastStep() {
  return Column(
    children: <Widget>[
      Text(
          'Based on the information you provided these are your health options: ',
          style: TextStyle(fontWeight: FontWeight.bold)),
      Container(
          child: ListTile(
        leading: Image.asset('images/medicare.png', width: 50, height: 50),
        title: Text("Medicare"),
        subtitle: Text('more detailed...'),
        onTap: () =>
            launch('https://www.medicaid.gov/medicaid-and-you/index.html'),
      )),
      Container(
          child: ListTile(
        leading: Image.asset('images/medicade.jpeg', width: 50, height: 50),
        title: Text("Medicade"),
        subtitle: Text('more detailed...'),
        onTap: () => launch(
      ...
      Container(
          child: ListTile(
        leading: Image.asset('images/bcbs.png', width: 50, height: 50),
        title: Text("Blue Cross Blue Shield NC"),
        subtitle: Text('more detailed...'),
        onTap: () => launch(
            'https://www.bluecrossnc.com/shop-plans/individual-and-family-plans'),
      )),
    ],
  );
}
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text(
                      'By answering this 3 minutes survey, we can help guide you to the perfect health insurance',
                      style: TextStyle(
                        fontSize: 16.0,
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: GestureDetector(
                      child: Container(
                        height: height.value,
                        decoration: BoxDecoration(
                            color: Colors.blue, borderRadius: radius.value),
                        child: Center(
...
class FourthQuestion {
  ...
  FourthQuestion(this.identifier, this.displayContent);
}
...
class FiveQuestion {
  ...
  FiveQuestion(this.identifier, this.displayContent);
}
...
class SixQuestion {
  ...
  SixQuestion(this.identifier, this.displayContent);
}
...
class SevenQuestion {
  ...
  SevenQuestion(this.identifier, this.displayContent);
}
